...
<body>
    ...
    <script>
        ...
        // Interactive mode control functions - simplified since IgnorePointer handles gesture blocking
        window.setInteractiveMode = function(interactive) {
            // Basic visual feedback - Flutter IgnorePointer handles gesture routing
            const container = document.getElementById('mermaid-container');
            const body = document.body;
            
            // Only disable user selection in interactive mode for cleaner interaction
            const userSelectValue = interactive ? 'none' : 'auto';
            body.style.userSelect = userSelectValue;
            body.style.webkitUserSelect = userSelectValue;
            body.style.msUserSelect = userSelectValue;
            
            if (container) {
                container.style.userSelect = userSelectValue;
            }
            
            // Optional: Add visual indicator class for styling
            body.classList.toggle('interactive-mode', interactive);
        };
